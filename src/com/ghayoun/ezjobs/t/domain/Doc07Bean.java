...
public class Doc07Bean implements Serializable {
	...
	public String getFail_comment() { return fail_comment; }
	public void setFail_comment(String fail_comment) { this.fail_comment = fail_comment; }
