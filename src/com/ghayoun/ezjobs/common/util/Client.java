...
public class Client {   
    ...
    public static void main(String[] args) throws Exception {
        ...
        client.start("192.168.10.201", Server.PORT_NUMBER);
        //client.start("localhost", Server.PORT_NUMBER);
    ...
    public class ClientThread extends Thread {   
        ...
        public void run() {   
            ...
            try {   
                ...
                System.out.println("Client SelectionKey.OP_READ :: " + SelectionKey.OP_READ);
