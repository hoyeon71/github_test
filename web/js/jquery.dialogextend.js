    ...
    if ($.ui.dialog)
    {
        ...
        $.extend(true, $.ui.dialog.prototype, {
            ...
            options: {
                ...
                refresh: false,
                openMaximized: false,
                maximizeFx: { easing: null, duration: 'normal', complete: null, start: null },
                restoreFx: { easing: null, duration: 'normal', complete: null, start: null }
            },
            ...
            {
                var t = this;
                if (t.options.refresh !== true || t.uiDialog.find('.ui-dialog-titlebar-refresh').length)
                    return;
                
                $('<a href="#" class="ui-dialog-titlebar-refresh ui-corner-all" role="button" title="Refresh"><span class="ui-icon ui-icon-refresh"></span></a>')
		            .insertBefore(t.uiDialog.find('.ui-dialog-titlebar .ui-dialog-titlebar-close'))
		            .click(function(e)
		            {
		                e.preventDefault();
		                ...
		                try{
		                	top.document.getElementById(t.uiDialog.find('iframe').attr('id')).contentWindow.goSearch();
		                }catch(e){}
            ...
            _calcMaxSize: function(backup)
            {
                ...
                return {
                    ...
                    h: $(window).height() - parseInt($(document.body).css("padding-top"), 10) - parseInt($(document.body).css('padding-bottom'), 10)-100
                };
            },
            ...
            _maxRestoreAnimated: function(fx, rect, opts, isMax)
            {
                ...
                t.uiDialog.animate(
                    rect,
                    {
                        ...
                        start: function()
                        {
                            if ($.isFunction(fx.start)) fx.start.call(this);
                        }
                    }
                );
            }
