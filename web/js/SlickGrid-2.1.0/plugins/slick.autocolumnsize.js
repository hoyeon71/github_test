(function($) {
    ...
    function AutoColumnSize(maxWidth) {
        ...
        $.fn.resizeAllColumns = function resizeAllColumns(_grid) {
    		...
    		var elHeaders		= containerNode.find(".slick-header-column");
        	var allColumns		= grid.getColumns();
        	
            elHeaders.each(function(index, el) {
//            	if(allColumns[grid.getColumnIndex($(el).data('column').id)].headerCssClass != 'cellHid') {
            	if(allColumns[index].headerCssClass != 'cellHid') {
