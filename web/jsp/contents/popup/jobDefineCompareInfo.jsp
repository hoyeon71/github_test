...
<%
	...
	JobMapperBean jobMapperDocPrevInfo	= (JobMapperBean)request.getAttribute("jobMapperDocPrevInfo");
	JobMapperBean jobMapperDocNowInfo	= (JobMapperBean)request.getAttribute("jobMapperDocNowInfo");
	String docCompareInfo				= (String)request.getAttribute("docCompareInfo");
	
	if(jobMapperDocPrevInfo == null){
		out.println("<script type='text/javascript'>");
		out.println("alert('이전 데이터가 존재하지 않습니다.');");
...
// 	}
	...
	if(jobMapperDocPrevInfo != null){
		...
		//if(!strPrevFromTime.equals("") && !strPrevToTime.equals("")){          
			strPrevTime = strPrevFromTime+"~"+strPrevToTime;                   
		//}else if(!strPrevFromTime.equals("") && strPrevToTime.equals(">")){    
			//strPrevTime = strPrevFromTime+"~";                                 
		//}else if(strPrevFromTime.equals("") && !strPrevToTime.equals("")){     
			//strPrevTime = strPrevToTime;                                       
		//}      
		
	//	if(!strPrevLateSub.equals("") && !strPrevLateTime.equals("")){     
			strPrevLate = strPrevLateSub+"~"+strPrevLateTime;              
		//}else if(strPrevLateSub.equals("") && !strPrevLateTime.equals("")){
		//	strPrevLate = strPrevLateSub+"~";                              
		//}else if(!strPrevLateSub.equals("") && strPrevLateTime.equals("")){ 
		//	strPrevLate = "~"+strPrevLateTime;                             
		//} 
		
		//if(!strPrevActiveFrom.equals("") && !strPrevActiveTill.equals("")){     
			strPrevActiveFromTill = strPrevActiveFrom+"~"+strPrevActiveTill;              
		//}else if(strPrevActiveFrom.equals("") && !strPrevActiveTill.equals("")){
		//	strPrevActiveFromTill = strPrevActiveFrom+"~";                              
		//}else if(!strPrevActiveFrom.equals("") && strPrevActiveTill.equals("")){ 
		//	strPrevActiveFromTill = "~"+strPrevActiveTill;                             
		//}  
	...
	if(jobMapperDocPrevInfo != null){
		...
		strPrevTableName	         =	CommonUtil.isNull(jobMapperDocPrevInfo.getSched_table());
		...
		strPrevMemName  		     =	CommonUtil.isNull(jobMapperDocPrevInfo.getMemname());
		strPrevMemLib		         =	CommonUtil.isNull(jobMapperDocPrevInfo.getMem_lib());
		strPrevCmdLine		         =	CommonUtil.isNull(jobMapperDocPrevInfo.getCmd_line());
		...
		strPrevCcCount	  		= CommonUtil.isNull(jobMapperDocPrevInfo.getCc_count(), "-");
	...
	if(jobMapperDocNowInfo != null){
		...
		strNowT_general_date = CommonUtil.isNull(jobMapperDocNowInfo.getT_general_date());
		
	 	if(!strNowT_general_date.equals("")){
			String temp_general_date = "";
			for(int i=4; i<=strNowT_general_date.length();i+=4){
				temp_general_date += strNowT_general_date.substring(i-4,i);
				temp_general_date += ", ";
			}
			
			if(!temp_general_date.equals("")) strNowT_general_date = temp_general_date.substring(0,temp_general_date.length()-2);
	 	}
	}
%>
...
<div style="width:100%; height:100%; overflow-x:hidden; overflow-y:scroll;">
	...
	<div class='cellTitle_kang'>담당자 정보</div>
	<table style='width:100%;'>
		...
		<thead>
			<tr bgcolor="#f1f1f1">
				<th class='cellTitle_kang2' style="font-size=:15px;">항목</th>
				<%if(docCompareInfo.equals("Y")){ %>
					<th class='cellTitle_kang2'>작업정보 (<%=CommonUtil.isNull(jobMapperDocNowInfo.getDoc_cd(), "-")%>)</th>
					<th class='cellTitle_kang2'>이전 작업정보 (<%=CommonUtil.isNull(jobMapperDocPrevInfo.getDoc_cd(), "-")%>)</th>
				<%}else{ %>
					<th class='cellTitle_kang2'>작업정보</th>
					<th class='cellTitle_kang2'>이전 작업정보 <%=jobMapperDocPrevInfo == null ? "<데이터 없음>":"" %></th>
				<%} %>
			</tr>
		</thead>
		<tbody>
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>담당자1</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>담당자2</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>담당자3</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>담당자4</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>담당자5</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>담당자6</th>
			...
			<tr align="center" class="dataTr">
			<th class='cellTitle_kang2'>담당자7</th>
			...
			<tr align="center" class="dataTr">
			<th class='cellTitle_kang2'>담당자8</th>
		...
		<tr align="center" class="dataTr">
			<th class='cellTitle_kang2'>담당자9</th>
		...
		<tr align="center" class="dataTr">
			<th class='cellTitle_kang2'>담당자10</th>
		...
		<tr align="center" class="dataTr">
			<th class='cellTitle_kang2'>그룹1</th>
		...
		<tr align="center" class="dataTr">
			<th class='cellTitle_kang2'>그룹2</th>
	...
	<table style='width:100%;table-layout:fixed; word-break:break-all;'>
		...
		<thead>
			<tr bgcolor="#f1f1f1">
				<th class='cellTitle_kang2' style="fond-size=:15px;">항목</th>
				<th class='cellTitle_kang2'>작업정보</th>
				<th class='cellTitle_kang2'>이전 작업정보</th>
			</tr>
		</thead>
		<tbody>
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>C-M</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>작업타입</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>폴더</th>
				<td class="cellContent_lee"><%=CommonUtil.isNull(jobMapperDocNowInfo.getSched_table(), "-") %></td>
				<td class="cellContent_lee"><%=CommonUtil.isNull(strPrevTableName, "-") %></td>
			</tr>
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>어플리케이션</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>그룹</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>수행서버</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>계정명</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>작업명</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>작업설명</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>프로그램명</th>
				<td class="cellContent_lee"><%=CommonUtil.isNull(jobMapperDocNowInfo.getMemname(), "-") %></td>
				<td class="cellContent_lee"><%=CommonUtil.isNull(strPrevMemName, "-") %></td>
			</tr>
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>프로그램위치</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>반복작업</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>최대 반복 횟수</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>Confirm Flag</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>성공 시 알람 발송</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>중요작업</th>
	...
	<div class='cellTitle_kang'>작업 스케쥴</div>
	<table style='width:100%;'>
		<colgroup>
			<col width="20%" />
			<col width="40%" />
		...
		<tbody>
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>월 캘린더</th>
				<td class="cellContent_lee"><%=CommonUtil.isNull(jobMapperDocNowInfo.getCalendar_nm(), "-") %></td>
				<td class="cellContent_lee"><%=CommonUtil.isNull(jobMapperDocPrevInfo.getCalendar_nm(), "-") %></td>
			</tr>
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2' >일 캘린더</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2' >POLICY</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2' >SHIFT</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2' >수행범위일</th>
			...
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2' >특정실행날짜</th>
				<td class="cellContent_lee"><%=CommonUtil.isNull(strNowT_general_date, "-") %></td>
				<td class="cellContent_lee"><%=CommonUtil.isNull(strPrevT_general_date, "-") %></td>
			</tr>
		</tbody>	
	</table>
	<div class='cellTitle_kang'>선행작업조건</div>
	<table style='width:100%;'>
		<colgroup>
			<col width="20%" />
			<col width="40%" />
		...
		<tbody>
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>선행작업조건</th>
	...
	<div class='cellTitle_kang'>후행작업조건</div>
	<table style='width:100%;'>
		<colgroup>
			<col width="20%" />
			<col width="40%" />
		...
		<tbody>
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>후행작업조건</th>
	...
	<div class='cellTitle_kang'>RESOURCE</div>
	<table style='width:100%;'>
		<colgroup>
			<col width="20%" />
			<col width="40%" />
		...
		<tbody>
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>RESOURCE</th>
	...
	<div class='cellTitle_kang'>변수</div>
	<table style='width:100%;'>
		<colgroup>
			<col width="20%" />
			<col width="40%" />
		...
		<tbody>
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>변수</th>
	...
	<table style='width:100%;'>
		...
		<tbody>
			<tr align="center" class="dataTr">
				<th class='cellTitle_kang2'>ON/DO</th>
