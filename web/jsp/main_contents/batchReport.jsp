...
<!--  					</td> -->
				...
				<tr>			
					<th><div class='cellTitle_kang2'>폴터</div></th>
...
// 			   		,{formatter:gridCellNoneFormatter,field:'group_name',id:'group_name',name:'그룹',minWidth:120,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
					,{formatter:gridCellNoneFormatter,field:'total_cnt',id:'RUNNING_CNT',name:'전체',minWidth:80,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'exec_cnt',id:'exec_cnt',name:'실행중(수행중)',minWidth:80,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'ok_cnt',id:'ok_cnt',name:'정상종료(성공)',minWidth:80,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'not_ok_cnt',id:'not_ok_cnt',name:'비정상종료(오류)',minWidth:80,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'wait_total',id:'wait_total',name:'대기',minWidth:80,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
// 			   		,{formatter:gridCellNoneFormatter,field:'wait_user_cnt',id:'wait_user_cnt',name:'대기_USER',minWidth:100,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
...
// 			   		,{formatter:gridCellNoneFormatter,field:'wait_host_cnt',id:'wait_host_cnt',name:'대기_HOST',minWidth:100,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
// 			   		,{formatter:gridCellNoneFormatter,field:'wait_condition_cnt',id:'wait_condition_cnt',name:'대기_CONDITION',minWidth:100,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
...
// 			   		,{formatter:gridCellNoneFormatter,field:'delete_cnt',id:'delete_cnt',name:'삭제',minWidth:75,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
					,{formatter:gridCellNoneFormatter,field:'percent',id:'percent',name:'성공율',minWidth:80,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
...
// 			$("input[name='application_of_def_text']").val(application);
			$("#f_s").find("input[name='p_application_of_def_text']").val(application);
...
// 		});
		...
		$("#btn_clear1").unbind("click").click(function(){
			...
			getAppGrpCodeList("application_of_def", "2", "", "", "");
	...
	function batchResultTotal(){
		...
		var url = '<%=sContextPath %>/common.ez?c=cData&itemGb=batchReport&itemGubun=2';
...
// 								var wait_time_cnt 		= $(this).find("wait_time_cnt").text();
								...
								var wait_total = parseInt(wait_user_cnt) + parseInt(wait_resource_cnt) + parseInt(wait_host_cnt) + parseInt(wait_condition_cnt);
								var percent;
								
								percent = (parseInt(ok_cnt)/parseInt(total_cnt)) * 100;
...
// 									,'wait_time_cnt': wait_time_cnt
	...
	function goExcel(){
		...
		frm.action = "<%=sContextPath %>/mEm.ez?c=ez046_excel";
		frm.target = "if1";
		frm.submit();
