									...
									<table style="width:100%;">
										...
										<tr>
											...
											<td>
												<div class='cellContent_kang'>
													...
													<input type="hidden" name="table_of_def" id="table_of_def" value='SUSI'/>

													<input type="hidden" name="table_name" id="table_name" value='SUSI'/>
											...
											<td>
												<div class='cellContent_kang'>
												SUSI
													<input type='hidden' id='application_of_def' name='application_of_def' value='SUSI' />
											...
											<td>
												<div class='cellContent_kang'>
													SUSI
													<input type='hidden' id='group_name_of_def' name='group_name_of_def' value='SUSI' />
										...
										<tr>
											...
											<td>
												<div class='cellContent_kang'>
													S_
													<input type="text" id="job_name" name="job_name" style="width:46%;height:21px;" />
										...
										<tr>
											...
											<td colspan="5">
												<div class='cellContent_kang'>
													<input type="text" name="t_general_date" id="t_general_date" style="width:87.5%; height:21px;" autocomplete="off" />
...
<!-- 													</select> -->
											...
											<td>	
												<div class='cellContent_kang'>
													...
													<input type='input' name='yaml_file' id='yaml_file' style="width:190px; height:21px;" readonly/>
							...
							<tr>
								<td valign="top">
									<table style="width:100%;display:none;">
										...
										<tr>
											...
											<td>
												<div class='cellContent_kang'>
													...
													<input type='text' id='week_days_text' name='week_days_text' value='' style="width:100px;height:21px;" maxlength='30' onkeypress='if(event.keyCode==32 || event.keyCode==39) event.returnValue = false;' style='ime-mode:disabled;' />
										...
										<tr>
											<td>
												<div class='cellTitle_kang2'>월 캘린더</div>
											</td>
											<td>
												<div class='cellContent_kang'>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		// 500 밀리세컨 후에 이벤트 발생
		setTimeout(function(){
			$('#task_type').val("command").prop("selected",true).trigger('change');
		}, 500);
...
// 		checkUserInfo();	//2024.02.26 최호연 담당자 SMS,MAIL 체크로직 제거
		...
		<%-- 		if( isNullInput(document.getElementById('sJobSchedGb'),'<%=CommonUtil.getMessageSplit("ERROR.PARAM.01","[작업주기구분]","") %>') ) return; --%>
