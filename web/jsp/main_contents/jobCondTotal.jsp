			...
			<table style='width:100%;'>
				<tr>
					...
					<td width="20%" style="text-align:left">
						...
						<select id="data_center_items" name="data_center_items" style="width:125px; height:21px;">							
...
<script>
	var gridObj = {
		...
		,colModel:[
					...
					,{formatter:gridCellNoneFormatter,field:'order_table',id:'order_table',name:'폴더',minWidth:120,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
					...
					,{formatter:gridCellNoneFormatter,field:'group_name',id:'group_name',name:'그룹',minWidth:120,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'reg_ok_cnt',id:'reg_ok_cnt',name:'정기-Ended Ok',minWidth:100,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'reg_fail_cnt',id:'reg_fail_cnt',name:'정기-Ended Not Ok',minWidth:150,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'reg_wait_cnt',id:'reg_wait_cnt',name:'정기-Wait',minWidth:70,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'reg_etc_cnt',id:'reg_etc_cnt',name:'정기-Etc.',minWidth:70,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'reg_total_cnt',id:'reg_total_cnt',name:'정기-Total',minWidth:100,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'reg_error_rate',id:'reg_error_rate',name:'정기-에러율',minWidth:100,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'irreg_ok_cnt',id:'irreg_ok_cnt',name:'비정기-Ended Ok',minWidth:130,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'irreg_fail_cnt',id:'irreg_fail_cnt',name:'비정기-Ended Not Ok',minWidth:150,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'irreg_wait_cnt',id:'irreg_wait_cnt',name:'비정기-Wait',minWidth:120,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'irreg_etc_cnt',id:'irreg_etc_cnt',name:'비정기-Etc.',minWidth:100,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'irreg_total_cnt',id:'irreg_total_cnt',name:'비정기-Total',minWidth:100,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'irreg_error_rate',id:'irreg_error_rate',name:'비정기-에러율',minWidth:100,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
...
<%-- 		var S_D_C_CODE 		= "<%=S_D_C_CODE%>"; 	//사용자의 select_data_center --%>
	...
	function jobCondTotal() {
		...
		var url = '<%=sContextPath %>/common.ez?c=cData&itemGb=jobCondTotal&itemGubun=2';
			...
			$(xmlDoc).find('doc').each(function(){
				...
				if(items.attr('cnt')=='0'){
					...
					items.find('item').each(function(i){
						...
						var reg_ok_cnt 			= $(this).find("reg_ok_cnt").text();
						var reg_fail_cnt 		= $(this).find("reg_fail_cnt").text();
						var reg_wait_cnt 		= $(this).find("reg_wait_cnt").text();
						var reg_etc_cnt 		= $(this).find("reg_etc_cnt").text();
						var reg_total_cnt		= $(this).find("reg_total_cnt").text();
						var reg_error_rate		= $(this).find("reg_error_rate").text();
						var irreg_ok_cnt 		= $(this).find("irreg_ok_cnt").text();
						var irreg_fail_cnt 		= $(this).find("irreg_fail_cnt").text();
						var irreg_wait_cnt 		= $(this).find("irreg_wait_cnt").text();
						var irreg_etc_cnt 		= $(this).find("irreg_etc_cnt").text();
						var irreg_total_cnt		= $(this).find("irreg_total_cnt").text();
						var irreg_error_rate	= $(this).find("irreg_error_rate").text();
						...
						rowsObj.push({
							...
							,'reg_ok_cnt': reg_ok_cnt
							,'reg_fail_cnt': reg_fail_cnt
							,'reg_wait_cnt': reg_wait_cnt
							,'reg_etc_cnt': reg_etc_cnt
							,'reg_total_cnt': reg_total_cnt
							,'reg_error_rate': reg_error_rate
							,'irreg_ok_cnt': irreg_ok_cnt
							,'irreg_fail_cnt': irreg_fail_cnt
							,'irreg_wait_cnt': irreg_wait_cnt
							,'irreg_etc_cnt': irreg_etc_cnt
							,'irreg_total_cnt': irreg_total_cnt
							,'irreg_error_rate': irreg_error_rate
						});
					});						
				}
	...
	function goExcel() {
		...
		frm.action = "<%=sContextPath %>/tWorks.ez?c=jobCondTotalExcel";
		frm.target = "if1";
		frm.submit();
