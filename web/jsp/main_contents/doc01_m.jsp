...
<%
	...
	// 등록복사를 통해 kubernetes의 값이 넘어올때 변수에서 넘어오기 때문에 한번더 체크해준다.
				...
				<td style='vertical-align:top;'>
					<h4 class="ui-widget-header ui-corner-all"  >
						<div id='t_<%=gridId %>' class='title_area'>
							<span><%=CommonUtil.getMessage("CATEGORY.GB.02")%> > <%=CommonUtil.getMessage("CATEGORY.GB.03.SB.0301") %></span>
						</div>
					</h4>
				</td>
			</tr>
							...
							<tr>
								<td valign="top">
									<table style="width:100%;">
										...
										<%--<tr>
											<td>
												<div class='cellTitle_kang2'><font color="red">* </font>요청 사유</div>
											</td>
											<td  colspan="5">
												<div class='cellContent_kang'>
													<input type="text" name="title" id="title" style="width:99%;height:21px;" value="<%=strTitle %>"/></div>
											</td>
										</tr>--%>
									</table>
								</td>
								...
								<td valign="top">
									<table style="width:100%;">
										...
										<tr>
											...
											<td>
												<div class='cellContent_kang' style='min-width:250px'>
													...
													<input type="hidden" name="data_center2" id="data_center2" value="<%=strDataCenter %>"/>
												</div>
											</td>
											<td>
										...
										<tr>
											...
											<td>
												<div class='cellContent_kang'>
<%-- 													<input type="text" id="job_name" name="job_name" value="<%=strJobName %>" style="width:50%;height:21px;" /> --%>
													<input type="text" id="job_name" name="job_name" value="<%=strJobName%>" style="width:50%;height:21px;" onblur="fn_change_job_name(this.id);" />
								...
								<td valign="top">
									<table style="width:100%;">
										...
										<tr>
											...
											<td>
												<div class='cellContent_kang'>
													<select id='execution_type' name='execution_type' style="width:24%;height:21px;">
														<option value="">--선택--</option>
								...
								<td valign="top">
									<table style="width:100%;">
										...
										<tr>
											...
											<td>
												<div class='cellContent_kang'>
													...
													<input type='text' id='week_days_text' name='week_days_text' value='<%=strTempWeekDays2%>' style='width:75px;height:21px;' maxlength='30' onkeypress='if(event.keyCode==32 || event.keyCode==39) event.returnValue = false;' style='ime-mode:disabled;' />
												</div>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td colspan="2">
												<div class='cellContent_kang'>
													<input type="text" name="t_general_date" id="t_general_date" value="<%=t_general_date%>" style="width:83%; height:21px;" autocomplete="off" onblur="fn_change(this.id);"/>
...
<!-- 													<td style='width:1px;height:21px;'><div class='cellTitle_kang2'></div></td> -->
													<td style='width:8%;'><input type='text' class='input' name='m_quantitative_res_name' value='<%=aTmpT1[0] %>' style='width:98%;height:21px;' maxlength='40'/></td>
													<td style='width:86%;'>
...
<%-- 												<td style='width:1px;height:21px;'><div class='cellTitle_kang2' id='div_user_val<%=t %>'></div></td> --%>
												...
												<td style='width:86%;'><input type='text' class='input' name='m_var_value' value='<%=CommonUtil.replaceHtmlStr(aTmpT1[1]) %>' style='width:88%;height:21px;' maxlength='214' /></td>
										<%
...
// 				if($("#job_name").val() + cond_suffix != first_job_name){
...
// 				}
			...
			*/
				...
				if(document.getElementById('task_type').value == 'MFT'){
...
// 			s += "<td style='width:1px;height:21px;'><div class='cellTitle_kang2' id='div_resq"+idx+"'></div></td>"
		...
		function addUserVars(){
			...
			s += "<td style='width:88%;'><input type='text' class='input' name='m_var_value' style='width:88%;height:21px;' maxlength='214'/>";
			s += "</tr>";
		...
		/*function addConditions(gb, job_nm, cond, and_or, add) {
			...
			if (gb == "in") {
				cond_paren_s = "";
				cond_paren_s += "<div class='gridInput_area'>";
				cond_paren_s += "<select name='paren_s" + val + "' id='paren_s" + val + "' style='width:40px;height:21px;'>";
				...
				cond_paren_e = "";
				cond_paren_e += "<div class='gridInput_area'>";
				cond_paren_e += "<select name='paren_e" + val + "' id='paren_e" + val + "' style='width:40px;height:21px;'>";
			...
			if(gb == "in" && flag != "ref"){
				...
				$("#paren_s"+val).val(parentheses_s).prop("selected", true);
				$("#paren_e"+val).val(parentheses_e).prop("selected", true);
