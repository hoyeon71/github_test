...
<%
	...
	// C-M 버전에 따라 스마트 테이블 등록 기능 유무.
	String strCmVersion = CommonUtil.isNull(CommonUtil.getMessage("CM_VERSION"));
								...
								<tr>
									...
									<td>
										<div class='cellContent_kang' style='min-width:250px'>
											...
											<input type="hidden" name="data_center" id="data_center" value="<%=CommonUtil.E2K(docBean.getData_center()) %>"/>
											<input type="hidden" name="data_center2" id="data_center2" value="<%=CommonUtil.E2K(docBean.getData_center()) %>" />
										</div>
									</td>
									<td>
									...
									<tr>
										...
										<td style='text-align:center;'>
											<label for='FTP_USE_DEF_NUMRETRIES_YN' style='width:50%'>
												<input type='checkbox' name='FTP_USE_DEF_NUMRETRIES_YN' id='FTP_USE_DEF_NUMRETRIES_YN' /> 
										...
										<td style='text-align:center;'>
											<label for='FTP_CONT_EXE_NOTOK'><input type='checkbox' name='FTP_CONT_EXE_NOTOK_YN' id='FTP_CONT_EXE_NOTOK_YN'/> 
		...
		<td style='vertical-align:top;'>
			<h4 class="ui-widget-header ui-corner-all" >
				...
				%>				
					...
					<%if ((CommonUtil.E2K(docBean.getApply_cd()).equals("04") || CommonUtil.E2K(docBean.getApply_cd()).equals("05")) && !strPopup_yn.equals("Y")) {%>
...
<script type="text/javascript">
	...
	var gridObj_1 = {
		...
		,colModel:[
			...
			,{formatter:gridCellNoneFormatter,field:'m_in_condition_parentheses_e',id:'m_in_condition_parentheses_e',name:')',width:60,headerCssClass:'cellCenter',cssClass:'cellCenter'}
	   		...
	   		,{formatter:gridCellNoneFormatter,field:'m_in_condition_and_or',id:'m_in_condition_and_or',name:'구분',width:70,headerCssClass:'cellCenter',cssClass:'cellLeft'}
	...
	var gridObj_2 = {
		...
		,colModel:[
	   		...
	   		,{formatter:gridCellNoneFormatter,field:'m_out_condition_date',id:'m_out_condition_date',name:'일자유형',width:80,headerCssClass:'cellCenter',cssClass:'cellLeft'}
	   		,{formatter:gridCellNoneFormatter,field:'m_out_condition_effect',id:'m_out_condition_effect',name:'구분',width:70,headerCssClass:'cellCenter',cssClass:'cellLeft'}
			,{formatter:gridCellNoneFormatter,field:'grid_idx',id:'grid_idx',name:'grid_idx',width:0,minWidth:0,headerCssClass:'cellHid',cssClass:'cellHid'}  		
	   	]
		,rows:[]
		,vscroll:false
...
// 		var systemGb	= $("#systemGb").val();
		...
		var t_general_date	= "<%=t_general_date%>";
...
<%-- 		$("#active_yn").val('<%=strActiveMent %>'); --%>
	...
	function goRefDocWrite() {
		...
		if( popup_yn == "Y") {
			opener.goWritePrc(encodeURI(param),doc_gb);
			window.close();
		}else{
		frm.flag.value 	= 'ref';
