...
<!-- 							<input type='hidden' id='application' name='application' value='' /> -->
	...
	<%-- <tr style='height:10px;'>
		<td valign="top">
			<input type="hidden" name="title" id="title" value="보고업무별현황"/>
...
<script type="text/javascript">
	var gridObj = {
		...
		,colModel:[
					...
					,{formatter:gridCellNoneFormatter,field:'GROUP_NAME',id:'GROUP_NAME',name:'그룹',width:180,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}	   		
			   		...
			   		,{formatter:gridCellNoneFormatter,field:'TOTAL_CNT',id:'TOTAL_CNT',name:'합계',width:110,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
...
// 		});
	...
	function groupJobHistory(){
		try{viewProgBar(true);}catch(e){}
		
		var url = '<%=sContextPath %>/common.ez?c=cData&itemGb=groupJobHistory';
...
function selectTable(eng_nm, desc){
	...
	function goExcel() {
		...
		frm.action = "<%=sContextPath %>/tWorks.ez?c=ez052_excel";
		frm.target = "if1";
		frm.submit();
	}
