		...
		<td style='vertical-align:top;'>
			...
			<table style='width:100%;'>
				<tr>
					...
					<th width="10%"><div class='cellTitle_kang2'>반영일</div></th>
					<td width="20%" style="text-align:left">
						<div class='cellContent_kang'>
						<input type="text" name="s_search_date" id="s_search_date" value="<%=odate %>" class="input datepick" style="width:70px; height:21px;" maxlength="8" onclick="dpCalMin('s_search_date','yymmdd');" readonly="readonly"/>
						 ~<input type="text" name="e_search_date" id="e_search_date" value="<%=odate %>" class="input datepick" style="width:70px; height:21px;" maxlength="8" onclick="dpCalMin('e_search_date','yymmdd');" readonly="readonly"/>
						</div>
					</td>
					<td width='10%'></td>
					<td width='15%'></td>
...
<script type="text/javascript">
	var gridObj = {
		...
		,colModel:[
					...
					,{formatter:gridCellNoneFormatter,field:'data_center',id:'data_center',name:'C-M',width:120,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
					,{formatter:gridCellNoneFormatter,field:'table_name',id:'table_name',name:'폴더',width:120,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
					,{formatter:gridCellNoneFormatter,field:'application',id:'application',name:'어플리케이션',width:120,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		...
			   		,{formatter:gridCellNoneFormatter,field:'D_CNT',id:'D_CNT',name:'정기요청서',width:120,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
// 			   		,{formatter:gridCellNoneFormatter,field:'W_CNT',id:'W_CNT',name:'수시요청서',width:120,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'T_CNT',id:'T_CNT',name:'삭제요청서',width:120,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'M_CNT',id:'M_CNT',name:'수정요청서',width:120,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'Q_CNT',id:'Q_CNT',name:'수행요청서',width:120,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'H_CNT',id:'H_CNT',name:'엑셀요청서',width:120,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   		,{formatter:gridCellNoneFormatter,field:'total_cnt',id:'total_cnt',name:'요청서합계',width:120,headerCssClass:'cellCenter',cssClass:'cellCenter',sortable:true}
			   	]
		,rows:[]
		,vscroll:false
	};
...
// 		$("#s_search_date").unbind('click').click(function(){
// 			dpCalMin(this.id,'yymmdd');
// 		});
		
		$("#btn_search").button().unbind("click").click(function(){
			var s_search_date = $("input[name='s_search_date']").val();
			var e_search_date = $("input[name='e_search_date']").val();
			$("#f_s").find("input[name='p_s_search_date']").val(s_search_date);
			$("#f_s").find("input[name='p_e_search_date']").val(e_search_date);
