    ...
    if p_flag ='ins' then
        begin
            ...
            values (
                   ...
                   ,p_interval_sequence
                   ,p_specific_times
                   ,( SELECT CASE WHEN p_tolerance = '' THEN 0 ELSE p_tolerance::integer END)
                   ,p_cyclic_type
                   ,p_active_from
                   ,p_active_till
            ...
            if (p_main_doc_cd = '' or p_main_doc_cd IS null ) then
                begin
                    ...
                    set
                      ...
                      ,table_id               = (CASE WHEN p_table_id = '' THEN 0 ELSE p_table_id::integer END)
                      ,job_id                 = (CASE WHEN p_job_id = '' THEN 0 ELSE p_job_id::integer END)
                      ...
                      ,retro                  = p_retro
                      ,max_wait               = (CASE WHEN p_max_wait = '' THEN 0 ELSE p_max_wait::integer END)
                      ,rerun_max              = (CASE WHEN p_rerun_max = '' THEN 0 ELSE p_rerun_max::integer END)
                      ...
                      ,tolerance			  = ( SELECT CASE WHEN p_tolerance = '' THEN 0 ELSE p_tolerance::integer END)
    ...
    if p_flag = 'original_ins' then
        begin
            ...
            values (
                   ...
                   ,(CASE WHEN p_table_id = '' THEN 0 ELSE p_table_id::integer END)
                   ,(CASE WHEN p_job_id = '' THEN 0 ELSE p_job_id::integer END)
                   ,p_data_center
                   ,p_table_name
                   ,p_application
                   ,p_group_name
                   ...
                   ,p_weeks_cal
                   ,p_retro
                   ,(CASE WHEN p_max_wait = '' THEN 0 ELSE p_max_wait::integer END)
                   ,(CASE WHEN p_rerun_max = '' THEN 0 ELSE p_rerun_max::integer END)
                   ,p_time_from
                   ,p_time_until
                   ,p_month_days
                   ,p_week_days
            ...
            select p_doc_cd, * from ezjobs.ez_job_mapper
