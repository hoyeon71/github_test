CREATE OR REPLACE PROCEDURE EZJOBS.SP_EZ_DOC_02_PRC_NEW
(
    r_code OUT varchar2,  r_msg OUT varchar2,  r_doc_cd OUT varchar2, p_flag varchar2, p_doc_cd varchar2, p_doc_gb varchar2, p_title varchar2, p_content varchar2, p_table_id varchar2, p_job_id varchar2, p_data_center varchar2, p_table_name varchar2, p_application varchar2, p_group_name varchar2, p_mem_name varchar2, p_job_name varchar2, p_description varchar2, p_author varchar2, p_owner varchar2, p_priority varchar2, p_critical varchar2, p_task_type varchar2, p_cyclic varchar2, p_node_id varchar2, p_rerun_interval varchar2, p_rerun_interval_time varchar2, p_mem_lib varchar2, p_command varchar2, p_confirm_flag varchar2, p_days_cal varchar2, p_weeks_cal varchar2, p_retro varchar2, p_max_wait varchar2, p_rerun_max varchar2, p_time_from varchar2, p_time_until varchar2, p_month_days varchar2, p_week_days varchar2, p_month_1 varchar2, p_month_2 varchar2, p_month_3 varchar2, p_month_4 varchar2, p_month_5 varchar2, p_month_6 varchar2, p_month_7 varchar2, p_month_8 varchar2, p_month_9 varchar2, p_month_10 varchar2, p_month_11 varchar2, p_month_12 varchar2, p_count_cyclic_from varchar2, p_time_zone varchar2, p_multiagent varchar2, p_user_daily varchar2, p_schedule_and_or varchar2, p_in_conditions_opt varchar2, p_t_general_date varchar2, p_t_conditions_in varchar2, p_t_conditions_out varchar2, p_t_resources_q varchar2, p_t_resources_c varchar2, p_t_set varchar2, p_t_steps varchar2, p_t_postproc varchar2, p_t_sfile varchar2, p_temp_doc_cd varchar2, p_t_tag_name varchar2, p_interval_sequence varchar2, p_specific_times varchar2, p_tolerance varchar2, p_cyclic_type varchar2, p_active_from varchar2, p_active_till varchar2, p_apply_date varchar2, p_apply_check varchar2, p_sr_code varchar2, p_conf_cal varchar2, p_shift varchar2, p_shift_num varchar2, p_dates_str varchar2, p_monitor_time varchar2, p_monitor_interval varchar2, p_filesize_comparison varchar2, p_num_of_iterations varchar2, p_stop_time varchar2, p_post_approval_time varchar2, p_post_approval_yn varchar2, p_grp_approval_userlist varchar2, p_grp_alarm_userlist varchar2, p_s_user_cd varchar2, p_s_user_ip varchar2
)
