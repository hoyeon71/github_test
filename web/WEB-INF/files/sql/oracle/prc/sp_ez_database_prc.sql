-- DROP FUNCTION ezjobs4.sp_ez_database_prc(out varchar, out varchar, in varchar, in varchar, in varchar, in varchar, in varchar, in varchar, in varchar, in varchar, in varchar, in varchar, in varchar, in varchar, in varchar, in varchar, in varchar);

CREATE OR REPLACE FUNCTION ezjobs4.sp_ez_database_prc(OUT r_code character varying, OUT r_msg character varying, p_flag character varying, p_database_cd character varying, p_profile_name character varying, p_data_center character varying, p_type character varying, p_port character varying, p_host character varying, p_user_nm character varying, p_password character varying, p_database_name character varying, p_database_version character varying, p_sid character varying, p_target_agent character varying, p_s_user_cd character varying, p_s_user_ip character varying)
 RETURNS record
 LANGUAGE plpgsql
AS $function$
